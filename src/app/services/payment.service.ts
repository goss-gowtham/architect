...
export class PaymentService {
  ...
  initiatePayUPayment(card: CardDTO, user: User, key: string, salt: string, live: boolean): Observable<void> {
    const baseUrl = !live ? 'https://test.payu.in/_payment' : 'https://secure.payu.in/_payment';
